...
export const AdminOptions: React.FC<AdminOptionsProps> = (props: AdminOptionsProps) => {
    ...
    const handletextChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => setChirp({
        id: chirp.id,
        user: chirp.user,
        text: e.target.value
    });
    ...
    return (
        <div className="container">
            ...
            <div className="mb-3">
                <textarea defaultValue={chirp.text} className="form-control" id="text-input" cols={50} rows={15} onChange={e => handletextChange(e)}></textarea>
            </div>
